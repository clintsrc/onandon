...
![GitHub Actions Cypress Test.](../images/spec/19-Actions-Cypress-Tests.png)

Your GitHub Actions for deployments should look similar to the image below:

![GitHub Actions Render Deploy.](../images/spec/19-Actions-Render-Deploy.png)
...
![Render image of auto deploy and hook](../images/spec/19-Render-Settings.png)
